...
<simconf version="2023090101">
  <simulation>
    ...
    <motetype>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="175.6606781086648" y="72.28666236653244" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.contikimote.interfaces.ContikiMoteID
          <id>10</id>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="15.487196133185888" y="26.87512846541672" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.contikimote.interfaces.ContikiMoteID
          <id>12</id>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="71.99494740035148" y="11.326109144174879" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.contikimote.interfaces.ContikiMoteID
          <id>13</id>
    ...
    <motetype>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="71.6773284808958" y="59.90668060588705" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.contikimote.interfaces.ContikiMoteID
          <id>5</id>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="173.55375691170846" y="131.3875225909054" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.contikimote.interfaces.ContikiMoteID
          <id>16</id>
  ...
  <plugin>
    ...
    <bounds x="1" y="1" height="644" width="574" z="2" />
  </plugin>
  <plugin>
    ...
    <bounds x="400" y="160" height="240" width="740" z="11" />
  </plugin>
  <plugin>
    ...
    <bounds x="0" y="665" height="166" width="1140" z="10" />
  </plugin>
  <plugin>
    ...
    <bounds x="400" y="0" height="160" width="740" />
  </plugin>
  <plugin>
    ...
    <bounds x="1101" y="659" height="126" width="362" z="9" />
  </plugin>
  <plugin>
    ...
    <bounds x="21" y="375" height="177" width="350" z="8" />
  </plugin>
  <plugin>
    org.contikios.cooja.plugins.MoteInterfaceViewer
    <mote_arg>1</mote_arg>
    ...
    <bounds x="400" y="415" height="130" width="350" z="6" />
  </plugin>
  <plugin>
    org.contikios.cooja.plugins.MoteInterfaceViewer
    <mote_arg>0</mote_arg>
    ...
    <bounds x="86" y="536" height="126" width="350" z="4" />
  </plugin>
  <plugin>
    org.contikios.cooja.plugins.MoteInterfaceViewer
    <mote_arg>6</mote_arg>
    ...
    <bounds x="458" y="539" height="122" width="350" z="5" />
  </plugin>
  <plugin>
    org.contikios.cooja.plugins.MoteInterfaceViewer
    <mote_arg>9</mote_arg>
    ...
    <bounds x="29" y="427" height="138" width="350" z="7" />
  </plugin>
  <plugin>
    org.contikios.cooja.plugins.MoteInterfaceViewer
    ...
    <bounds x="0" y="0" height="300" width="350" z="3" />
  </plugin>
  <plugin>
    org.contikios.cooja.serialsocket.SerialSocketServer
    <mote_arg>15</mote_arg>
    ...
    <bounds x="1038" y="440" height="126" width="362" z="1" />
  </plugin>
</simconf>
